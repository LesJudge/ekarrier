<div class="col-data-3">
	<div class="form_row">
		...
		-->
		{html_options name=$SelMegye.name id=$SelMegye.name options=$SelMegye.values selected=$SelMegye.activ class='select-type-1'} 
	...
	<div class="form_row">
		...
		-->
		{html_options name=$SelVaros.name id=$SelVaros.name options=$SelVaros.values selected=$SelVaros.activ class='select-type-1'} 
