...
/**
 * {$publikusnev} Admin List controller.
 */
class {$modulnevUpper}_Admin_Controller extends Admin_List{
    
    protected $_multiple_lang = {$multilang}; // Nyelvesítés.
    protected $_verify_event_manual = {$manual_validation}; // Kézi validálás.
    public $_name = '{$modulnevUpper}List';
    ...
    public function __show(){
        parent::__show();
        Rimo::$_site_frame->assign('Form', $this->__generateForm('modul/{$modulnev}/view/admin.{$modulnev}_list.tpl'));
    }
