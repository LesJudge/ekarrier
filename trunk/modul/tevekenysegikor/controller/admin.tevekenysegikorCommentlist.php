...
class TevekenysegikorCommentlist_Admin_Controller extends Admin_List
{

        public $_name='TevekenysegikorCommentList';
        ...
        {
                parent::__show();
                Rimo::$_site_frame->assign('Form', $this->__generateForm('modul/tevekenysegikor/view/admin.tevekenysegikor_comment_list.tpl'));
        }

        public function onClick_Filter()
        {
                $nameFilter="mk.kategoria_cim LIKE '%:item%' OR 
                ...
                {
                        case 1:
                                $this->setWhereInput('tevekenysegikor_hozzaszolas_aktiv=1','FilterStatus');
                                break;
                        case 2:
                                $this->setWhereInput('tevekenysegikor_hozzaszolas_aktiv=0','FilterStatus');
                                break;
                        default:
                ...
                {
                        case 1:
                                $this->setWhereInput('tevekenysegikor_hozzaszolas.checked = 0','FilterChecked');
                                break;
                        case 2:
                                $this->setWhereInput('tevekenysegikor_hozzaszolas.checked = 1','FilterChecked');
                                break;
                        default:
