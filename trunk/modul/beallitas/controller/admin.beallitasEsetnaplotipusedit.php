 ...
 */
class BeallitasEsetnaplotipusedit_Admin_Controller extends Admin_Edit
{
    /**
     * Controller neve.
     * @var string
     */
    public $_name = 'AdminBeallitasEsetnaploTipusEdit';
    /**
     * Constructor.
     */
    public function __construct()
    {
        $this->__loadModel('_EsetnaploTipusEdit');
        parent::__construct();
