...
<form action="" method="POST" name="{$FormName}" id="{$FormName}" class="form form_list" enctype="multipart/form-data">
        <div class="box_top">
                <h2 class="icon pages">Tevékenységi körök - Hozzászólások</h2>
                <ul class="sorting">
        ...
        <div class="box_content">    
                ...
                <table class="sorting">
                        ...
                        <tr class="data_row">
                                ...
                                <td class="align_left"><a href="{$APP_LINK}/commentedit/{$lista.ID}{$LANG_PARAM}" title="Módosítás">{$lista.elso}</a></td>
