...
<form action="" method="POST" name="{$FormName}" id="{$FormName}" class="form form_list" enctype="multipart/form-data">
        <div class="box_top">
                <h2 class="icon pages">{block name="title"}Munkakör tartalom kiegészítések{/block}</h2>
                <ul class="sorting">
        ...
        <div class="box_content">    
                ...
                <div class="top_filtering">
                        ...
                        {html_options name=$FilterFeldolgozva.name options=$FilterFeldolgozva.values selected=$FilterFeldolgozva.activ}
                        <div class="clear"></div>
                </div>
                ...
                <table class="sorting">
                        ...
                        <tr class="data_row">
                                ...
                                <td class="align_left center">{$lista.feldolgozva}</td>
