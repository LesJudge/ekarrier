...
class BeallitasPoziciocomment_Admin_Controller extends Admin_List
{

        public $_name='BeallitasPoziciocommentlist';
        public $_multiple_lang = false;

        public function __construct()
        {
                $this->__loadModel('_Pozicio_Comment_List');
                parent::__construct();
        ...
        {
                parent::__show();
                Rimo::$_site_frame->assign('Form', $this->__generateForm('modul/beallitas/view/admin.pozicio_comment_list.tpl'));
        }

        public function onClick_Filter()
        {
                $nameFilter="p.pozicio_nev LIKE '%:item%' OR 
                ...
                {
                        case 1:
                                $this->setWhereInput('pozicio_hozzaszolas_aktiv=1','FilterStatus');
                                break;
                        case 2:
                                $this->setWhereInput('pozicio_hozzaszolas_aktiv=0','FilterStatus');
                                break;
                        default:
                ...
                {
                        case 1:
                                $this->setWhereInput('pozicio_hozzaszolas.checked = 0','FilterChecked');
                                break;
                        case 2:
                                $this->setWhereInput('pozicio_hozzaszolas.checked = 1','FilterChecked');
                                break;
                        default:
