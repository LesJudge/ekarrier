 ...
 */
class BeallitasMunkarendedit_Admin_Controller extends Admin_Edit
{
    /**
     * Controller neve.
     * @var string
     */
    public $_name = 'AdminBeallitasMunkarendEdit';
    /**
     * Constructor.
     */
    public function __construct()
    {
        $this->__loadModel('_MunkarendEdit');
        parent::__construct();
    ...
    public function __show()
    {
        ...
        Rimo::$_site_frame->assign(
            'Form',
            $this->__generateForm('modul/beallitas/view/admin.beallitas_munkarend_edit.tpl')
        );
    }
}