<div class="uw-ugyfelkezelo-form">
    ...
    <div class="uw-ugyfelkezelo-form-row">
        ...
        {include file="modul/user/view/partial/ugyfel/edit/sheep_it_education.tpl"}
    </div><!--/.uw-ugyfelkezelo-form-row-->
    <div class="uw-ugyfelkezelo-form-row">
        <label>Nyelvtudás</label>
        {include file="modul/user/view/partial/ugyfel/edit/sheep_it_knowledge.tpl"}
    </div><!--/.uw-ugyfelkezelo-form-row-->
    <div class="uw-ugyfelkezelo-form-row">
        <label>Számítógépes ismeret</label>
        {include file="modul/user/view/partial/ugyfel/edit/sheep_it_computer_knowledge.tpl"}
    </div><!--/.uw-ugyfelkezelo-form-row-->
    <div class="uw-ugyfelkezelo-form-row">
