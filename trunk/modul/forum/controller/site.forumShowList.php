...
class ForumShowList_Site_Controller extends Page_List
{
    ...
    public function __show()
    {
        ...
        try
        {
            ...
            //$this->_view->assign('isAuthorized',UserLoginOut_Site_Controller::isAuthorized());
            $this->_view->assign('isAuthorized',(int)Rimo::getClientWebUser()->verify(UserLoginOut_Site_Controller::$_id));
