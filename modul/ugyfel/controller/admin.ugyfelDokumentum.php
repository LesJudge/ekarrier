...
require 'modul/ugyfel/library/DocumentManager.php';
/**
 * @property User_UgyfelDokumentum_Model $_model Model
 */
class UgyfelDokumentum_Admin_Controller extends AjaxController
{
    protected $ajaxOnly = false;
    
    public function __run()
    {
        $this->__loadModel('_Dokumentum');
        parent::__run();
    }
    ...
    public function __show()
    {
        try {
            ...
            Rimo::$_site_frame->assign('Form', $this->__generateForm(
                'modul/user/view/admin.ugyfel_dokumentum.tpl'
            ));
        } catch (\Exception $e) {
            $this->invalidRequest();
        }
