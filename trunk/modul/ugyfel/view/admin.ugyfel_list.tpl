...
{include file="modul/ugyfel/view/partial/list/client_export.tpl"}
...
groupLabels['ugyfelDfLastname'] = 'Alap adatok';
...
<form action="" method="POST" name="{$FormName}" id="{$FormName}" class="form form_list" enctype="multipart/form-data">
    ...
    <div class="box_content">    
        ...
        <div id="dynamicFilters" class="uw-df-filters">
            ...
            {include file="modul/ugyfel/view/partial/list/dynamic_filters.tpl"}
        </div><!--/#dynamicFilters-->
        <table class="sorting">
            ...
            {foreach from=$Lista key=for_id item=lista}
                <tr class="data_row">
                    ...
                    <td class="align_left"><a href="{$APP_LINK}/edit/{$lista.ID}{$LANG_PARAM}" title="Módosítás">{$lista.vezeteknev}</a></td>
                    <td class="align_left center">{$lista.keresztnev}</td>
                    <td class="align_left center">
                        {if $lista.felhasznalonev != ""}
                        {$lista.felhasznalonev}
                        {else}
                        <i>Nem regisztrált felhasználó!</i>
                        {/if}
                    </td>
                    <td class="align_left center">{$lista.email}</td>
                    <td class="align_left center">{if $lista.nem eq "male"}Férfi{elseif $lista.nem eq "female"}Nő{/if}</td>
