...
<form action="" method="post" name="{$FormName}" id="{$FormName}" class="form form_editor " enctype="multipart/form-data">
    <div class="grid_18">
        <div class="box_top">
            <h2 class="icon time">Program információ - [{$edit_mode}]</h2>
        ...
        <div class="box_content padding">
            ...
            <div class="field">
                ...
                <div class="clear"></div>
                <div class="form_row">
                    <label>Mező <span class="require">*</span></label>
                    {html_radios name=$ChkField.name options=$ChkField.values selected=$ChkField.activ}
                    {if isset($ChkField.error)}<p class="error small">{$ChkField.error}</p>{/if}
                </div>
                <div class="clear"></div>
            </div>
            <div class="field">
