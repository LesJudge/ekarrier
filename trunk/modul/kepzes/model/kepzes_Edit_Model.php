<?php
class Kepzes_Edit_Model extends Admin_Edit_Model
{
    /**
     * Tábla neve.
     * @var string
    ...
    public $_bindArray=array(
        'kepzes_nev' => 'TxtNev',
        'kepzes_leiras' => 'TxtLeiras',
        'kepzes_aktiv' => 'ChkAktiv',
    );
    /**
    ...
    public function __editData()
    {
        ...
        $query = "SELECT modositas_szama, 
                  ...
                  WHERE kepzes_id = " . (int)$this->modifyID . " LIMIT 1";
