<?php
class Beallitas_UgyfelAllapotList_Model extends Admin_List_Model
{
    /**
     * Tábla neve.
     * @var string
     ...
     * @var string
     */
    public $_fields = 'user_allapot.user_allapot_id AS ID,
                       nev AS elso,
                       letrehozas_timestamp,
                       modositas_timestamp,
                       modositas_szama,
                       user_allapot_aktiv AS Aktiv,
    ...
    public function __addForm()
    {
        ...
        $this->tableHeader=array(
            ...
            'user_allapot_aktiv' => array('label' => 'Közzétéve', 'width' => 8)
        );
