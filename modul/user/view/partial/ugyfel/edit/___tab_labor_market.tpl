<div class="uw-ugyfelkezelo-form">
    <div class="uw-ugyfelkezelo-form-row">
        <label>{$LaborMarket->getAttributeLabel('palyakezdo')}</label>
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label>{$LaborMarket->getAttributeLabel('regisztralt_munkanelkuli')}</label>
        <div class="uw-ugyfelkezelo-form-yes-no">
            <label>
                <input 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label for="labor-market-mikor-regisztralt">{$LaborMarket->getAttributeLabel('mikor_regisztralt')}</label>
        <input 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label>{$LaborMarket->getAttributeLabel('gyes_gyed_visszatero')}</label>
        <div class="uw-ugyfelkezelo-form-yes-no">
            <label>
                <input 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label>{$LaborMarket->getAttributeLabel('megvaltozott_mkepessegu')}</label>
        <div class="uw-ugyfelkezelo-form-yes-no">
            <label>
                <input 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label for="labor-market-mvegzes-keok">{$LaborMarket->getAttributeLabel('mvegzes_keok')}</label>
        <textarea 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label for="labor-market-kov-felulv-date">{$LaborMarket->getAttributeLabel('kov_felulv_date')}</label>
        <input 
    ...
    <div class="uw-ugyfelkezelo-form-row">
        <label>{$LaborMarket->getAttributeLabel('dolgozik')}</label>
        <div class="uw-ugyfelkezelo-form-yes-no">
            <label>
                <input 
    ...
    <div id="tab-labor-market-workplace-data">
        <div class="uw-ugyfelkezelo-form-row">
            <label for="labor-market-dolgozik-nev">{$LaborMarket->getAttributeLabel('dolgozik_nev')}</label>
            <input 
        ...
        <div class="uw-ugyfelkezelo-form-row">
            <label for="labor-market-dolgozik-cim">{$LaborMarket->getAttributeLabel('dolgozik_cim')}</label>
            <input 
        ...
        <div class="uw-ugyfelkezelo-form-row">
            <label for="labor-market-dolgozik-munkakor">{$LaborMarket->getAttributeLabel('dolgozik_munkakor')}</label>
            <input 
