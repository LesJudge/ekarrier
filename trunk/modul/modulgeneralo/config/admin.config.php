<?php
/**
 * Modulgenerálóhoz tartozó config fájl.
 * @author Petró Balázs Máté <balazs@uniweb.hu>
 */
// Alkalmazás gyökere.
$config['APP_PATH'] = 'modulgeneralo';
// Könyvtárak neveit tartalmazó tömb, amelyeket le kell generálnia.
$config['DIRS'] = array('config', 'controller', 'model', 'upload', 'view');
// True or False tömb.
