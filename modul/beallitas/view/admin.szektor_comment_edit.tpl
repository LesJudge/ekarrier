...
<form action="" method="post" name="{$FormName}" id="{$FormName}" class="form form_editor " enctype="multipart/form-data">
        <div class="grid_18">
                <div class="box_top">
                        <h2 class="icon time">Szektor hozzászólás - [{$edit_mode}]</h2>
                ...
                <div class="box_content padding">
                        ...
                        <div class="form_muvelet">
                            ...
                            <a href="{$DOMAIN_ADMIN}beallitas/szektorcomment" id="{$FormName}_close"><img class="tip" title="{php}echo LANG_AdminEdit_megse;{/php}" src="../images/admin/icons/cancel.png"/></a>
                        
                        </div> 
                        <div class="field">
                            <label for="info">{$secDesc.nev}</label>
                            <textarea id="info" class="mceNonEditable">{$secDesc.tartalom}</textarea>    
