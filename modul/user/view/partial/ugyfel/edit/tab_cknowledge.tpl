            ...
            <div class="shpt-form shpt-form-cknowledge">
                ...
                <div class="shpt-form-body">
                    <div class="shpt-form-row">
                        <input id="cKnowledgeForm_#index#_user_attr_szgep_ismeret_id" name="models[uc_knowledge][#index#][user_attr_szgep_ismeret_id]" type="hidden" value="" />
                        <input id="cKnowledgeForm_#index#_user_attr_szgep_ismeret_id_error" type="hidden" value="" />
