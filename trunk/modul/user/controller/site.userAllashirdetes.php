 ...
 */
class UserAllashirdetes_Site_Controller extends Page_List
{
    /**
     * Controller neve a $_SESSION szuperglobálisban.
     * @var string
     */
    public $_name = 'SiteUserAllashirdetesList';
    /**
    ...
    public function __construct()
    {
        ...
        $this->__loadModel('_Site_Allashirdetes_List');
        parent::__construct(Rimo::$_config->SITE_NYELV_ID);
        $this->_model->listWhere['ugyfel_id'] = 'ugyfel_attr_allashirdetes_megjelolt.ugyfel_id = ' . $clientId;
    ...
    public function __show()
    {
        ...
        Rimo::$_site_frame->assign(
            'Content',
            $this->__generateForm('modul/' . Rimo::$_config->APP_PATH . '/view/site.user_allashirdetes_list.tpl')
        );
    }
