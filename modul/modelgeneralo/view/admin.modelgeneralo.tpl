...
<form action="" method="post" name="{$FormName}" id="{$FormName}" class="form form_editor " enctype="multipart/form-data">
	<div class="grid_24">
    	<div class="box_top">
            <h2 class="icon time">Modelgeneralo 4 Rimo</h2>
        ...
        <div class="box_content padding">
            ...
            <div id="tabs-1" class="field">
                ...
                <div class="form_row">Pl. dwa
                    <label for="{$TxtModulNev.name}">Modul neve <span class="require">*</span></label>
                ...
                <div class="form_row">Pl. Parameter
                    <label for="{$TxtModelNev.name}">Generálandó model neve <span class="require">*</span></label>
                    <input type="text" id="{$TxtModelNev.name}" name="{$TxtModelNev.name}" value="{$TxtModelNev.activ}"/>
                    {if isset($TxtModelNev.error)}<p class="error small">{$TxtModelNev.error}</p>{/if}
		</div><div class="clear"></div>
                
                <div class="form_row">Pl. dwa_parameter
                    <label for="{$TxtTablaNev.name}">Modelhoz tartozó tábla neve <span class="require">*</span></label>
                ...
                <div class="form_row">Pl. Dwa Paraméter
                    <label for="{$TxtPublikusNev.name}">Model publikus neve <span class="require">*</span></label>
