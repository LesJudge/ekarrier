...
/**
 * Archív álláshirdetéseket megjelenítő controller.
 * 
 ...
 */
class AllashirdetesArchivum_Site_Controller extends AllashirdetesBaseListController
{
    /**
     * Controller neve a $_SESSION szuperglobálisban.
     * @var string
     */
    public $_name = 'SiteAllashirdetesArchivum';
    /**
     ...
     * @var string
     */
    protected $seoKey = 'jobSearchArchive';
    /**
    ...
    {
        $this->_view->assign('isArchive', true);
    }
}