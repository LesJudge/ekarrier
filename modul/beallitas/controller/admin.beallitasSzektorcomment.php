...
class BeallitasSzektorcomment_Admin_Controller extends Admin_List
{

        public $_name='BeallitasSzektorcommentlist';
        public $_multiple_lang = false;

        public function __construct()
        {
                $this->__loadModel('_Szektor_Comment_List');
                parent::__construct();
        ...
        {
                parent::__show();
                Rimo::$_site_frame->assign('Form', $this->__generateForm('modul/beallitas/view/admin.szektor_comment_list.tpl'));
        }

        public function onClick_Filter()
        {
                $nameFilter="sz.szektor_nev LIKE '%:item%' OR 
                ...
                {
                        case 1:
                                $this->setWhereInput('szektor_hozzaszolas_aktiv=1','FilterStatus');
                                break;
                        case 2:
                                $this->setWhereInput('szektor_hozzaszolas_aktiv=0','FilterStatus');
                                break;
                        default:
                ...
                {
                        case 1:
                                $this->setWhereInput('szektor_hozzaszolas.checked = 0','FilterChecked');
                                break;
                        case 2:
                                $this->setWhereInput('szektor_hozzaszolas.checked = 1','FilterChecked');
                                break;
                        default:
