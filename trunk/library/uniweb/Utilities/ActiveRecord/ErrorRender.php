<?php
namespace Uniweb\Library\Utilities\ActiveRecord;
use Smarty;
...
class ErrorRender
{
    ...
    protected function validateParameters(array $params)
    {
        ...
        if (array_key_exists('model', $params) && array_key_exists('property', $params) && array_key_exists('view', $params)) {
            return true;
        } else {
