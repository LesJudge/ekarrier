...
class Beallitas_MunkarendList_Model extends Admin_List_Model
{
    /**
     * Tábla neve.
     * @var string
    ...
    public function __addForm()
    {
        ...
        $this->_params['TxtSort']->_value='sorrend__ASC';
