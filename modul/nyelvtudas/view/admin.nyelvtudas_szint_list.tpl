...
<form action="" method="POST" name="{$FormName}" id="{$FormName}" class="form form_list" enctype="multipart/form-data">
    <div class="box_top">
        <h2 class="icon pages">Nyelvtudás [szintek]</h2>
        <ul class="sorting">
    ...
    <div class="box_content">    
        ...
        <table class="sorting">
            ...
            <tr class="data_row">
                ...
                <td class="align_left center">{$lista.nyelvtudas_szint_letrehozas_datum}</td>
                <td class="align_left center">
                    {if $lista.nyelvtudas_szint_modositas_szama gt 0}
                    {$lista.modosito_nev}
                    {else}
                    Nem lett módosítva!
                    {/if}
                ...
                <td class="align_left center">
                    {if $lista.nyelvtudas_szint_modositas_szama gt 0}
                    {$lista.nyelvtudas_szint_modositas_datum}    
                    {else}
                    Nem lett módosítva!
                    {/if}
                </td>
                <td class="align_left center">{$lista.nyelvtudas_szint_modositas_szama}</td>
                <td class="align_left center">
                {if $lista.Aktiv}
