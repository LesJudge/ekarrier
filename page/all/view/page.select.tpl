...
<div class="site_body_container">	
	<div class="site_content site_center">     
		{$ErrorMessage}
		<a href="{$DOMAIN}?type=mv" class="start-infobox"><span class="start-infobox-bub start-infobox-bub-1"><span class="start-infobox-bub-arrow"></span> <span class="start-infobox-logo"></span> <span class="start-infobox-data"><span class="start-infobox-data-title">{$munkavallaloInfo.infobox_nev} </span> {$munkavallaloInfo.infobox_tartalom}</span> </span> <img src="images/site/start_mv.png" alt="" class="start-logo" /><span class="start-infobox-name start-infobox-name-1">Álláskereső</span> </a>
		<a href="{$DOMAIN}?type=ma" class="start-infobox"><span class="start-infobox-bub start-infobox-bub-2"><span class="start-infobox-bub-arrow"></span> <span class="start-infobox-logo"></span> <span class="start-infobox-data"><span class="start-infobox-data-title">{$munkaltatoInfo.infobox_nev} </span> {$munkaltatoInfo.infobox_tartalom} </span> </span> <img src="images/site/start_ma.png" alt="" class="start-logo" /> <span class="start-infobox-name start-infobox-name-2">Munkáltató</span></a>  
		<div class="clear"></div>  
