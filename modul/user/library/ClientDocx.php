...
class ClientDocx
{
    ...
    {
        $this->config = require 'modul/user/config/admin.clientDocx.config.php';
    }
    ...
    public function generateDocx()
    {
        ...
        $addRow('Telefon', $this->client->clientdata->telefonszam_vezetekes);
        $addRow('E-mail cím', $this->client->user_email);
        // n:m lista.
