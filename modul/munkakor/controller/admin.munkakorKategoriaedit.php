...
class MunkakorKategoriaedit_Admin_Controller extends Admin_Edit {
    public function __construct() {
        
       $this->_name = Rimo::$_config->KT_EDITFORM_NAME;
        $this->_model = $this->__loadPublicModel("munkakor","_Kategoria_Admin_Edit");
        parent::__construct();
    ...
    public function __show(){
        ...
        Rimo::$_site_frame->assign("Form", $this->__generateForm("modul/munkakor/view/admin.munkakorkategoria_edit.tpl"));
