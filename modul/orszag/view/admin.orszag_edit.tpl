...
<form action="" method="post" name="{$FormName}" id="{$FormName}" class="form form_editor " enctype="multipart/form-data">
    <div class="grid_24">
    	<div class="box_top">
			<h2 class="icon time">Ország - [{$edit_mode}]</h2>
        ...
        <div class="box_content padding">
            ...
            <div class="field">
				<div class="form_row">
					<label for="{$TxtNev.name}">Ország név <span class="require">*</span></label>
				...
				<div class="form_row">
					<label for="{$TxtRovidites.name}">Ország rövidítés <span class="require">*</span></label>
