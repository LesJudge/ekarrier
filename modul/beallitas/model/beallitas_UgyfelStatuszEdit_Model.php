...
class Beallitas_UgyfelStatuszEdit_Model extends Admin_Edit_Model
{
    /**
     * Tábla neve.
     * @var string
    ...
    public function __editData()
    {
        ...
        $query = "SELECT modositas_szama, 
                         ...
                         modositas_timestamp, 
                         ugyfel_statusz_aktiv AS active,
                  ...
                  WHERE ugyfel_statusz_id = " . (int)$this->modifyID . " LIMIT 1";
