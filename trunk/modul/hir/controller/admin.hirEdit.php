...
class HirEdit_Admin_Controller extends Admin_Edit {
    public $_name = "HirmEdit";
    ...
    public function __show(){
        ...
        Rimo::$_site_frame->assign("Form", $this->__generateForm("modul/hir/view/admin.hir_edit.tpl"));
    }
    ...
    public function onLoad_Edit(){
        parent::onLoad_Edit();
        $this->_view->assign("hir_allapot", $this->_model->hirAllapot()); 
    }
