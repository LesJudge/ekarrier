            ...
            <div class="field">
                <div id="user-edit-tabs">
                    ...
                    <div id="tab-ugyfel-informacio">
                        {include file="modul/ugyfel/view/partial/edit/tab_ugyfel_informacio.tpl"}
                    </div><!--/#tab-ugyfel-informacio-->
                    <div id="tab-szemelyes-adatok">
                        {include file="modul/ugyfel/view/partial/edit/tab_szemelyes_adatok.tpl"}
                    </div><!--/#tab-szemelyes-adatok-->
                    <div id="tab-munkaeropiaci-helyzete">
                        {include file="modul/ugyfel/view/partial/edit/tab_munkaeropiaci_helyzete.tpl"}
                    </div><!--/#tab-munkaeropiaci-helyzete-->
                    <div id="tab-projektinformaciok">
                        {include file="modul/ugyfel/view/partial/edit/tab_projektinformaciok.tpl"}
                    </div><!--/#tab-projektinformaciok-->
                    <div id="tab-munkakorokmunkarend">
                        {include file="modul/ugyfel/view/partial/edit/tab_munkakorokmunkarend.tpl"}
                    </div><!--/#tab-munkakorokmunkarend-->
                    <div id="tab-nytszgp">
                        {include file="modul/ugyfel/view/partial/edit/tab_nytszgp.tpl"}
                    </div><!--/#tab-nytszgp-->
                    <div id="tab-allaskeresesi-aktivitas">
                        {include file="modul/ugyfel/view/partial/edit/tab_allaskeresesi_aktivitas.tpl"}
                    </div><!--/#tab-allaskeresesi-aktivitas-->
                    <div id="tab-szolgaltatas">
                        {include file="modul/ugyfel/view/partial/edit/tab_services.tpl"}
                    </div><!--/#tab-szolgaltatas-->
                    {if not $client->is_new_record()}
                    <div id="tab-project">
                        {include file="modul/ugyfel/view/partial/edit/tab_project.tpl"}
                    </div>
                    <div id="tab-contact">
                        {include file="modul/ugyfel/view/partial/edit/tab_contact.tpl"}
                    </div>
                    <div id="tab-documents">
                        {include file="modul/ugyfel/view/partial/edit/tab_documents.tpl"}
                    </div>
                    {/if}
                    <div id="tab-login">
                        {include file="modul/ugyfel/view/partial/edit/tab_login.tpl"}
                    </div><!--/#tab-login-->
                </div><!--/#user-edit-tabs-->
            </div><!--/.field-->
            {/if}
