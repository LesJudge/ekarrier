...
if(!defined('MAX_WIDTH')) define('MAX_WIDTH',2500);
...
{
	$ALLOWED_SITES = array('flickr.com','picasa.com','img.youtube.com','upload.wikimedia.org','photobucket.com','imgur.com','imageshack.us','tinypic.com');
}
...
class timthumb
{
	...
	public function __construct()
	{
		...
		$this->src = "./modul/".$this->param('m')."/upload/".$this->param('d').$this->src;
	...
	protected function processImageAndWriteToCache($localImage)
	{
		...
		{
			$imageFilters = array(1  => array(IMG_FILTER_NEGATE,0),2  => array(IMG_FILTER_GRAYSCALE,0),3  => array(IMG_FILTER_BRIGHTNESS,1),4  => array(IMG_FILTER_CONTRAST,1),5  => array(IMG_FILTER_COLORIZE,4),6  =>
				array(IMG_FILTER_EDGEDETECT,0),7  => array(IMG_FILTER_EMBOSS,0),8  => array(IMG_FILTER_GAUSSIAN_BLUR,0),9  => array(IMG_FILTER_SELECTIVE_BLUR,0),10 => array(IMG_FILTER_MEAN_REMOVAL,0),11 => array(IMG_FILTER_SMOOTH,
					0),);
		}
