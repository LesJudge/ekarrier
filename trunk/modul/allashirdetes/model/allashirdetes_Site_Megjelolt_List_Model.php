 ...
 */
class Allashirdetes_Site_Megjelolt_List_Model extends Page_List_Model
{
    /**
     * Tábla neve.
     * @var string
     */
    public $_tableName = 'user_attr_allashirdetes_megjelolt';
    /**
     * Kiválasztott mezők.
     * @var string
     */
    public $_fields = 'user_attr_allashirdetes_megjelolt.allashirdetes_id,
                       a.link,
                       a.megnevezes,
                       a.ellenorzott,
                       cv.cim_varos_nev,
     ...
     * @var string
     */
    public $_join = 'INNER JOIN allashirdetes a ON user_attr_allashirdetes_megjelolt.allashirdetes_id = a.allashirdetes_id
