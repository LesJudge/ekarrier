<?php
class Tartalom_Edit_Model extends Admin_Edit_Model {
    ...
    public function __addForm(){
       ...
       // $SelTitle = $this->addItem("SelTitle");
    //	$SelTitle->_select_value = $this->getSelectValues("tartalom", "tartalom_cim", "", "ORDER BY tartalom_cim");
    //	$SelTitle->_verify["select"] = true;
    ...
    public function __update(){
        ...
        $this->updateMenu($this->modifyID, $this->_params["TxtCim"]->_value, $this->_params["TxtLink"]->_value, $this->_params["ChkAktiv"]->_value,$this->_params["ChkKiemelt"]->_value);
    }
    ...
    public function __insert(){
        ...
        if($this->modifyID)
            $this->insertMenu($this->modifyID, $this->_params["TxtCim"]->_value, $this->_params["TxtLink"]->_value, $this->_params["ChkAktiv"]->_value,$this->_params["ChkKiemelt"]->_value);      
    }
